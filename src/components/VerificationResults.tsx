...
export default function VerificationResults({ result, onClose }: VerificationResultsProps) {
  console.log('[VerificationResults] Component rendered with result:', result)
